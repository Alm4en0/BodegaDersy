                ...
                <form action="{{ route('suppliers.index') }}" method="GET">
                    <div class="card">
                        <div class="input-group input-group-outline" style="width: 20rem">
                            <label class="form-label">Ingrese el nombre del Proveedor</label>
                                ...
                                <table class="table align-items-center mb-0 text-center">
                                    ...
                                    <tbody>
                                        @foreach ($suppliers as $supplier)
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <form action="{{ route('suppliers.destroy', $supplier->id) }}"
                                                        method="POST">
                                                        <button type="button" class="btn bg-gradient-info btn-link"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#exampleModalMessage{{ $supplier->id }}">
                                                            Ver
                                                        </button>
                                            ...
                                            <div class="modal fade" id="exampleModalMessage{{ $supplier->id }}"
                                                tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Detalles de
                                                                Proveedor: <span id="supplierName"></span></h5>
                                                            ...
                                                            <ul class="list-group">
                                                                <li
                                                                    ...
                                                                    <div class="d-flex flex-column">
                                                                        <h6 class="mb-3 text-m">Nombre: <span
                                                                                id="modalSupplierName">{{ $supplier->name }}</span>
                                                                        </h6>
                                                                        <h6 class="mb-2 text-sm">Teléfono: <span
                                                                                id="modalSupplierPhone"
                                                                                class="opacity-9">
                                                                                {{ $supplier->phoneNumber }}</span>
                                                                        </h6>
                                                                        <h6 class="mb-2 text-sm">WhatsApp: <span
                                                                                id="modalSupplierWhatsapp"
                                                                                class="opacity-9">{{ $supplier->whatsApp }}</span>
                                                                        </h6>
                                                                        <h6 class="mb-2 text-sm">Servicios: <span
                                                                                id="modalSupplierProducts"
                                                                                class="opacity-9">{{ $supplier->products }}</span>
                                                                        </h6>
                                                                    </div>
                                                                </li>
                                                            </ul>
