    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-4">
            ...
            <div class="d-flex justify-content-between mb-3 my-3">
                ...
                <div>
                    <a class="btn bg-gradient-dark mb-0" href="{{ route('ventas.create') }}">
                        <i class="material-icons text-sm">add</i>&nbsp;&nbsp;Agregar Venta
                    </a>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-warning shadow-primary border-radius-lg pt-4 pb-3">
                                <h5 class="text-white text-capitalize ps-3">Tabla de Ventas</h5>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0 text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <form action="{{route('ventas.destroy', $ventas->id)}}" method="POST">
                                                    ...
                                                    href="{{route('ventas.edit', $venta->id)}}" data-original-title=""
                                                    title="">
                                        ...
                                        <div class="modal fade" id="exampleModalMessage{{$ventas->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
