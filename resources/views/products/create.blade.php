                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="mb-3 col-md-12">
                                            ...
                                            <input type="text" name="description" class="form-control border border-2 p-2" value='{{ old('description')}}'>
                                            @error('description')
                                                <p class='text-danger inputerror'>{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="mb-3 col-md-12">
                                            ...
                                            <input type="number" step="0.01" name="p_price" class="form-control border border-2 p-2" value='{{ old('p_price')}}'>
                                            @error('p_price')
                                                <p class='text-danger inputerror'>{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="mb-3 col-md-12">
                                            ...
                                            <input type="number" step="0.01" name="s_price" class="form-control border border-2 p-2" value='{{ old('s_price') }}'>
                                            @error('s_price')
                                                <p class='text-danger inputerror'>{{ $message }}</p>
                                            @enderror
                                        </div>
